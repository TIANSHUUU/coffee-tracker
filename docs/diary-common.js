...
(function () {
  ...
  function getLang() {
    // default English; only Chinese when explicitly chosen
  ...
  const UI = {
    zh: {
      ...
      summary: '总评', origin: '产区', source: '查看产品', viewOrigin: '查看产区位置',
      details: '详情', producer: '生产者', farm: '庄园', region: '产区', varietal: '品种', process: '处理法',
      roasted: '烘焙', firstBrew: '首冲',
      ...
      filterAll: '全部', allMonths: '全部月份', timeline: '时间线', roast: { filter: '手冲', espresso: '意式', omni: '通用' },
    ...
    en: {
      ...
      summary: 'Summary', origin: 'Origin', source: 'View product', viewOrigin: 'View origin',
      details: 'Details', producer: 'Producer', farm: 'Farm', region: 'Region', varietal: 'Varietal', process: 'Process',
      roasted: 'Roasted', firstBrew: 'First brewed',
      ...
      filterAll: 'All', allMonths: 'All months', timeline: 'Timeline', roast: { filter: 'Filter', espresso: 'Espresso', omni: 'Omni' },
